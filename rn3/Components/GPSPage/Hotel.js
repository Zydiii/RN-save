...
export default class Hotel extends React.Component {
    ...
    getRoundData() {
        ...
        return fetch('http://api.map.baidu.com/place/v2/search?query=酒店&location=' +
    ...
    async getResult() {
        for (var i = 0; i < roundData.length; i++) {
            ...
            this.setState({
                ...
                list: [
                    {
                        pic: 'http://pv18mucav.bkt.clouddn.com/hotel.png',
    ...
    async getPic(pic, i) {
        let url = "http://202.120.40.8:30454/imgidentify/imgidentify/gethotel"
